...
namespace WinFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private string connectionString = @"Data Source=ArtAks;Initial Catalog=master;Integrated Security=True;TrustServerCertificate=True;"; // Замените на вашу строку подключения
        ...
        private void LoadProducts()
        {
            ...
            try
            {
                ...
                queryBuilder.Append($" ORDER BY Price {sortDirection}");
